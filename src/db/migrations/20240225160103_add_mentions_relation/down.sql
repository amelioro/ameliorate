-- AlterEnum
BEGIN;
CREATE TYPE "EdgeType_new" AS ENUM ('causes', 'addresses', 'createdBy', 'has', 'criterionFor', 'creates', 'embodies', 'supports', 'critiques', 'asksAbout', 'potentialAnswerTo', 'relevantFor', 'sourceOf', 'relatesTo', 'accomplishes');
