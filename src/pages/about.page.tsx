    ...
    <>
      ...
      <Box display="flex" justifyContent="center">
        <PaperMiddle>
          ...
          <Typography variant="body1">
            <b>Alpha (current)</b>: tool is usable, core features exist but are unrefined, tool may
            feel clunky to use, bugs are expected, no established userbase
          </Typography>
          <Typography variant="body1">
            <b>Beta</b>: core features are somewhat refined, tool does not feel clunky to use, bugs
            are expected, established userbase is forming
          </Typography>
          <Typography variant="body1">
