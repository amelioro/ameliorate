...
/**
 * Forwarding ref so that MUI tooltip can wrap this button https://mui.com/material-ui/react-tooltip/#custom-child-element
 */
export const ScoreButton = forwardRef<HTMLButtonElement, ScoreButtonProps>(
  function ScoreButton(props, ref) {
    const {
      ...
      className = "",
      /**
       * I guess MUI Tooltip passes other props here, see https://mui.com/material-ui/react-tooltip/#custom-child-element
       */
      ...restProps
    } = props;
