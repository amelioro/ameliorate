...
const svgMarkerDef = (inReactFlow: boolean) => (
  <defs>
    <marker
      id={inReactFlow ? flowMarkerId : nonFlowMarkerId}
      markerWidth="30"
      markerHeight="30"
      viewBox="-10 -10 20 20"
...
export const ScoreEdge = ({ inReactFlow, ...flowEdge }: EdgeProps & Props) => {
  ...
  const path = (
    <StyledPath
      ...
      markerStart={`url(#${inReactFlow ? flowMarkerId : nonFlowMarkerId})`}
      spotlight={spotlight}
