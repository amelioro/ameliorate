...
import { blogPage, discordInvite, githubRepo } from "@/web/common/urls";
    ...
    >
      ...
      <Toolbar className="h-12 min-h-auto">
        <div className="flex flex-1 items-center justify-between gap-4 *:shrink-0">
          ...
          <div className="flex items-center gap-4">
            <NavLink href="https://ameliorate.app/docs" className="hidden sm:block">
              Docs
            </NavLink>
            <NavLink href={blogPage} className="hidden md:block">
              Blog
            </NavLink>
