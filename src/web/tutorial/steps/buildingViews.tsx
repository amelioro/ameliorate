            ...
            <ZoomableImage
              ...
              modalText={
                <span>
                  ...
                  <br />
                  <br />
                  They can also be a good starting point for others to see what's important about
                  your topic.
                </span>
              }
              imageProps={{
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <>
            <ZoomableImage
              modalTitle="Information Filters"
              modalText={
                <span>
                  Information Filters control filtering based on categories of info - Breakdown (
                  <NodeTypeText type="problem" />,
                  <NodeTypeText type="solution" />, etc), Research (
                  <NodeTypeText type="question" />, <NodeTypeText type="fact" />,{" "}
                  <NodeTypeText type="source" />, etc), and Justification (
                  <NodeTypeText type="support" />
                  , <NodeTypeText type="critique" />
                  ).
                  <br />
                  <br />
                  Here we're toggling on the Research category, which adds questions, facts, and
            ...
            <ZoomableImage
              ...
              modalText={
                <span>
                  ...
                  <br />
                  <br />
                  Here we're filtering out <NodeTypeText type="cause" /> nodes, and choosing to
                  override that to show the "street goes downhill" cause.
                </span>
              }
              imageProps={{
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <>
            <ZoomableImage
              modalTitle="Hidden neighbors"
              modalText={
                <span>
                  If a node's handle is blue, that means it has a neighbor that's currently being
                  hidden by a filter.
                  <br />
                  <br />
                  You can un-hide a hidden neighbor by clicking on the eye, or re-hide it by
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <>
            <ZoomableImage
              modalTitle="Showing & hiding neighbors"
              modalText={
                <span>
                  It's not uncommon to want to only look at a node and its neighbors, or to add all
                  of a node's neighbors to the view.
                  <br />
                  <br />
                  You can find actions for these by right-clicking on a node.
                </span>
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <>
            <ZoomableImage
              modalTitle="Forcing nodes into layers"
              modalText={
                <span>
                  One example of a view option that isn't a filter is the "Force nodes into layers"
                  option.
                  <br />
                  <br />
                  This lays out problems at the top, criteria in the middle, and solutions at the
                  bottom. Sometimes it's desirable to turn this off and keep nodes closer together.
                </span>
              }
              imageProps={{
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <>
            <ZoomableImage
              modalTitle="Saving Quick Views"
              modalText={
                <span>
                  When you've got your view the way you want it, you can create a Quick View.
                  <br />
                  <br />
                  If you change any filters after creating it and you want to update that view with
                  new settings, you can click the save icon to re-save that view's settings.
                </span>
              }
              imageProps={{
