          ...
          <ZoomableImage
            ...
            modalText={
              <span>
                ...
                Click the "Show indicators" button <TabUnselected /> in the toolbar to show scores
      ...
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            ...
            modalText={
              <span>
                By default, you'll see your own scores, but if you're viewing a topic that others
                have scored too, you can compare scores.
                <br />
                <br />
                You can also go to the More Actions Drawer to choose which perspectives to view.
              </span>
  ...
  },
  {
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            modalTitle="Justification"
            modalText={
              <span>
                You can add <NodeTypeText type="support" /> or <NodeTypeText type="critique" />{" "}
                nodes to justify positive or negative opinions. Details like these can be found in
                the Details Pane <VerticalSplit color="primary" /> after selecting a node or edge.
                <br />
                <br />
                Here we're supporting that "pedestrians might get hit" is concerning because it
                reduces the feeling of safety in the neighborhood.
              </span>
            }
            imageProps={{
      ...
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            ...
            modalText={
              <span>
                You can add a <NodeTypeText type="question" /> to indicate something that would be
                good to find out, or a <NodeTypeText type="fact" /> or{" "}
                <NodeTypeText type="source" /> to point out other relevant information.
                <br />
                <br />
                These can also all be scored, just like any other node, to convey your opinion on
                them.
              </span>
            }
            imageProps={{
        ...
        imageSlot={
          <>
            <ZoomableImage
              ...
              modalText={
                <span>
                  You can use Notes for any additional info, or Comments to start a discussion about
                  the part.
                </span>
              }
              imageProps={{
  ...
  },
  {
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            modalTitle="Indicators"
            modalText={
              <span>
                There are indicators <TabUnselected /> for each kind of info, so you know
                at-a-glance where extra details are.
              </span>
            }
            imageProps={{
