...
export const getReadingDiagramSteps = (track?: Track | null): StepType[] => [
  {
    ...
    content: (
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            modalTitle="Nodes and edges"
            modalText={
              <span>
                We use nodes to represent concepts, and edges to represent relations between those.
                <br />
                <br />
                Here we have a <NodeTypeText type="problem" /> node saying that "cars going too
                fast" is a problem, and an edge from the <NodeTypeText type="cause" /> that
                indicates "street goes downhill" causes (to some extent) cars to go too fast.
              </span>
            }
            imageProps={{
      ...
      <StepContent
        ...
        imageSlot={
          <ZoomableImage
            ...
            modalText={
              <span>
                Scores convey positive or negative opinion about a node or edge. If you're logged
                in, you can score other people's topics. Click the "Show indicators" button{" "}
                <TabUnselected /> in the toolbar to show scores and other indicators.
                <br />
                <br />
                Here we're saying that we think pedestrians getting hit is a big concern, and that
