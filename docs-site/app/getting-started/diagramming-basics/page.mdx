...
<Image
  ...
  alt="low-scored benefit next to high-scored detriment"
  width={419}
  height={299}
/>
...
<Image
  ...
  alt="view details indicator on node"
  width={377}
  height={174}
/>
...
<Image
  ...
  alt="added a support node to another support node"
  width={453}
  height={515}
/>
...
<Image
  ...
  alt="view justification tree indicator"
  width={373}
  height={173}
/>
...
<Image
  ...
  alt="alternative diagram-based way to add a nested support node"
  width={832}
  height={165}
/>
...
Let's return to our problem breakdown by clicking the back arrow in the Toolbar (or clicking Breakdown in the Quick Views list). Select the Detriment node again, and take a look at the Research section:

<Image
  src="https://github.com/amelioro/ameliorate/assets/13872370/7d7ef02e-bf8c-420d-8b84-19cd9609fcdc"
  alt="node research section"
  width={786}
  height={516}
/>
...
Those are the basics of how Ameliorate works - now you can try it out on your own problems! Check out [Breakdown Process & Phases](/breakdown-process-phases) if you're not sure where to start with breaking down your own topic. If you have questions, feel free to ask in the [Discord server](https://discord.gg/3KhdyJkTWT).
