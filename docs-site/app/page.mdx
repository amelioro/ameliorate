...
- 🔮 If you'd like to get some background about motivation and goals for the tool, see [Goals](/goals) or you can read the [Announcement Blog Post](https://medium.com/@keyser.joel/a-dream-to-ameliorate-547353f37945).
