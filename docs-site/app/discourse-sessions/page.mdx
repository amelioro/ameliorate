...
- May use [phases](/breakdown-process-phases) to keep the discussion focused e.g. take a break for participants to choose their own scores for the diagram (to quickly convey their opinions), or to research the topic for a few minutes
