...
- 🎓 If you'd like to learn the basics of how to use the tool, visit the app ([Start Building](https://ameliorate.app/new) or [Play Around](https://ameliorate.app/playground)) to use the tutorials, or read [Getting Started](/getting-started).
