...
After creating your first Topic, you'll be greeted by the Topic Workspace:

![image](https://github.com/amelioro/ameliorate/assets/13872370/e0a8b631-d759-4959-9400-e12f52b17531)

The Topic Workspace is divided into a few sections:

1. the Topic Diagram - this is where you'll build out the structure of your Topic with concepts (via boxes called nodes) and relations between them (via lines called edges).
2. the Topic Pane - on the Details tab, you can see more details about the Topic, or about the currently-selected node or edge; on the Views tab, you can switch between ways of looking at the Topic Diagram.
3. the Topic Toolbar - here you'll find buttons to take different actions, like undo/redo and delete.

## Nodes

At the center of your diagram, there's a purple node with a few details on it:

![image](https://github.com/amelioro/ameliorate/assets/13872370/5b031702-52ca-499e-aac1-880490d9fb6f)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/c4f74efa-41cc-4f32-afdc-6d21841ed0f3)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/12099a44-4162-45c7-9848-4811e77eb802)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/dc5063e6-a0ec-4d6a-b7fd-a988a166e63e)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/7f7964a1-bfd0-43c2-9aa8-ed02cd92f2cf)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/f03ccd09-9407-409b-b9f9-cf81c1b5ec5d)

1. notes for the node - scratch details, or any extra context to clarify the node
2. claims - supports or critiques for the node; these can be used to justify why the node may be more important or less important
3. research - questions, facts, or sources that are relevant to the node

Let's add a Support "reduces feeling of safety in neighborhood" to the Detriment node.

![image](https://github.com/amelioro/ameliorate/assets/13872370/0a0d4f40-39fa-414e-ab3e-b511727e6372)

### Chaining justification

You can also chain claims together, for example to justify why the feeling of safety is important. You can do this two different ways. The first way is to go to the details for the Support you added by clicking the Details Indicator:

![image](https://github.com/amelioro/ameliorate/assets/13872370/84659b35-c4b4-4956-9869-a3090ed8e8c7)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/0cec2503-7f79-4b8c-a11d-3f00bcd18559)

The second way is to view the claim tree for the node; let's click the Claim Tree indicator:

![image](https://github.com/amelioro/ameliorate/assets/13872370/0f253a0d-5899-4f9e-aa0d-b775342598c1)

then we can add a node the same way we added our Benefit and Detriment nodes:

![image](https://github.com/amelioro/ameliorate/assets/13872370/e96678d4-cfc7-4a7f-a4a0-fc36b2bdec48)
...
Let's return to our Topic structure by clicking the 'x' in the upper-right corner of this Claim Tree, select the Detriment node again, and take a look at the Research section:

![image](https://github.com/amelioro/ameliorate/assets/13872370/7d7ef02e-bf8c-420d-8b84-19cd9609fcdc)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/bf3d9342-9279-4045-9504-1ec0d1e2068f)

Let's also add a Fact "residential street has 25 mph speed limit" to the Problem "cars going too fast in my neighborhood":

![image](https://github.com/amelioro/ameliorate/assets/13872370/0e91786f-6369-469a-8c8e-9f7c57d83dba)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/090fad3e-6aed-4268-aefe-9e0b17bfcad2)
...
![image](https://github.com/amelioro/ameliorate/assets/13872370/26da4210-0533-4ec8-b39a-ed97ff6fdf4c)
