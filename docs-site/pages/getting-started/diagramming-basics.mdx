...
1. the Topic Diagram - this is where you'll build out the structure of your Topic with nodes and edges.
...
For more advanced usage, check out the other pages in the App section of this documentation, e.g. [Features](/features) or [Diagramming Choices](/diagramming-choices).
