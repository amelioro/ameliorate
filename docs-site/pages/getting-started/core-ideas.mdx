...
- the concepts and relations used to convey the structure of a problem are constrained specifically to the domain of solving problems - this enables a consistent way of representing and understanding them, and enables specialized tooling to be built for viewing and working with the structure.
